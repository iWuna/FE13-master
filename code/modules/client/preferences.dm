...
/datum/preferences
	...
	var/age = 21						//age of character
	var/underwear = "Nude"				//underwear type
	var/undershirt = "Nude"				//undershirt type
	var/socks = "Nude"					//socks type
	var/backbag = DBACKPACK				//backpack type
	var/hair_style = "Short Hair"				//Hair type
	var/hair_color = "98683d"				//Hair color
	var/facial_hair_style = "Shaved"	//Face hair type
	var/facial_hair_color = "98683d"		//Facial hair color
	var/skin_tone = "gray"		//Skin color
	var/eye_color = "5fcb55"				//Eye color
